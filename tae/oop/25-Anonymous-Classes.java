...
// After the constructor call, we have opened the curly braces and have overridden the method's implementation on the fly.
// The modification is applicable only to the current object, and not the class itself. So if we create another object of that class, the method's implementation will be the one defined in the class.
